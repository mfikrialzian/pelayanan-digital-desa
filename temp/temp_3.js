        ...
        function handleMulaiPengajuan() {
            var isAdmin = sessionStorage.getItem('adminToken_Narmada') !== null;
            ...
            if (reqs.length === 0) {
                ...
                if (groupedReqs["Wajib"]) {
                    ...
                    groupedReqs["Wajib"].forEach(function (item) {
                        htmlBuffer += '<div class="flex items-center space-x-1.5 py-0.5 pl-1"><span class="text-narmadaGreen font-extrabold text-[9px]">âœ”ï¸</span> <span class="text-[10px] text-slate-600 font-semibold">' + item + '</span></div>';
                    });
                    htmlBuffer += '</div>';
                }
