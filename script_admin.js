            ...
            linksArray.forEach(function (item, idx) {
                ...
                if (p.length >= 2) {
                    ...
                    var card = '<div class="' + slideClass + '">' +
                        '<div class="flex items-center bg-slate-50 p-4 shrink-0 border-b border-slate-200">' +
                        ...
                        '<h3 class="font-bold text-slate-500 uppercase tracking-wider text-[10px] flex items-center gap-2"><i class="fa-regular fa-file-image text-narmadaGreen"></i> ' + labelName + '</h3>' +
                        '</div>' +
                        '</div>' +
