...
# Let's target all inputs inside the right column of subview-admin-layanan.
# Actually, the easiest way is to target the specific IDs:
builder_inputs = [
